...
export default function About() {
    return(
      <section id="about">
        ...
        <div className="flex px-10 py-20 md:flex-row flex-col items-center bg-emerald-700">
          <div className="lg:flex-grow flex flex-col mb-16 md:mb-0 items-center text-center mx-5 my-5">
